...
**ツール名**: Hexカラーコードの暗いと明るいグラデーションクエリツール  
**ツールの説明**: Hexカラーコードのグラデーション生成とクエリツールを使用して、さまざまな色のグラデーション効果を探索します。Hexカラーコードを入力して、その暗いと明るいグラデーションを表示します。  
**ツールカテゴリ**: カラーツール  
**リンク**: https://www.tools366.com/ja/tool/color-shades-and-tints


**ツール名**: カラースキームおよび関連するカラーツール  
**ツールの説明**: さまざまなカラースキームを探索および生成します。Hexカラーコードを入力して、その色の補色、三色組、分割補色、類似色、およびモノクロスキームを表示します。  
**ツールカテゴリ**: カラーツール  
**リンク**: https://www.tools366.com/ja/tool/related-colors


**ツール名**: Webセーフカラー オンライン検索ツール  
**ツールの説明**: このツールを使用して、安全で読みやすいCSSカラーを見つけて適用します。HexとRGB形式の両方に対応。  
**ツールカテゴリ**: カラーツール  
**リンク**: https://www.tools366.com/ja/tool/web-safe-colors
