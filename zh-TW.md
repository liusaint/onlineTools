...
**工具名稱**: 在線批量圖片尺寸縮放工具  
**工具描述**: 本地縮放PNG/JPG/JPEG等格式圖片，自由選擇縮放比例和尺寸，保留或不保留長寬比例，原格式輸出  
**工具類別**: 圖片工具  
...
**工具名稱**: 線上GIF製作工具 - 自訂動畫GIF  
**工具描述**: 使用這個線上GIF製作工具，您可以通過上傳圖片，設定時間間隔、寬度和高度來創建自定義的動畫GIF。多圖合成GIF。  
**工具類別**: 圖片工具  
**連結**: https://www.tools366.com/zh-TW/tool/gif-maker


**工具名稱**: GIF拆分成單獨幀的在線工具  
**工具描述**: 在線工具，將GIF分解成單獨的幀，方便查看、編輯和使用。  
**工具類別**: 圖片工具  
**連結**: https://www.tools366.com/zh-TW/tool/gif-splitter
...
**工具名稱**: 顏色配置和相關顏色工具  
**工具描述**: 探索和生成多種顏色模式。輸入一個Hex顏色碼，查看該顏色的互補色、三色組、分裂互補三色組、類似色以及單色方案。  
**工具類別**: 顏色工具  
**連結**: https://www.tools366.com/zh-TW/tool/related-colors


**工具名稱**: Web安全色線上查詢工具  
**工具描述**: 使用這個工具來查找和應用安全、易讀的CSS顏色。支持Hex和RGB格式。  
**工具類別**: 顏色工具  
**連結**: https://www.tools366.com/zh-TW/tool/web-safe-colors
