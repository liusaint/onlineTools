...
**Nome da ferramenta**: Ferramenta de Compressão de Imagens PNG Online  
**Descrição da ferramenta**: Comprima imagens PNG localmente, compressão única, compare a qualidade da compressão, pré-visualize a compressão  
**Categoria da ferramenta**: Ferramentas de Imagem  
